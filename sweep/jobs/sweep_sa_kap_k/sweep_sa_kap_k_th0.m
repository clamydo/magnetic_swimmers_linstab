...
res0=Parallelize@Table[
{{0, dr, dt, sa, sm dr \[Kappa], k, \[Kappa]} /. myparams, eval@@({0, dr, dt, 2 sa, sm dr \[Kappa], k, \[Kappa]} /. myparams)},
{sa,Table[i, {i, -3, 3, 0.05}]},
{\[Kappa],Table[i, {i, 0, 25, 0.1}]},
{k,Join[{0}, Table[1/100 2^i, {i,0,9}]]}
];
Export[$ScriptCommandLine[[3]]<>"/sweep_sa_kap_k_th0_"<>$ScriptCommandLine[[2]]<>".m", res0]
